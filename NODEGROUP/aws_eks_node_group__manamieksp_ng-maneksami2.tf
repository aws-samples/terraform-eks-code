...
# aws_eks_node_group.manamieksp_ng-maneksami2:
resource "aws_eks_node_group" "manamieksp_ng-maneksami2" {
  ami_type       = "AL2_x86_64"
  depends_on     = [aws_eks_cluster.manamieksp]
  cluster_name   = "manamieksp"
  disk_size      = 0
  instance_types = []
  labels = {
  ...
  node_role_arn   = aws_iam_role.eksctl-manamieksp-nodegroup-ng-ma-NodeInstanceRole-1GFKA1037E1XO.arn
