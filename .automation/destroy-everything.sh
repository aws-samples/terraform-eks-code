...
cur=`pwd`
date
dirs="extra/.karpenter extra/.fargate/fargateapp extra/.fargate extra/sampleapp2 extra/eks-cidr2 extra/nodeg2 sampleapp lb2 cicd eks-cidr nodeg cluster c9net iam net"
for i in $dirs; do
cd $cur
cd ../$i
